...
public class LiveTournamentService {
    ...
    public List<Tournament> getAllActiveTournaments() {
        try {
            ...
            log.error("Function getAllActiveTournaments is throwing an error: {}", e.getMessage(), e);
            throw e;
        }
    }
    ...
    public List<Tournament> getAllTournaments() {
        try {
            ...
            log.error("Function getAllTournaments is throwing an error: {}", e.getMessage(), e);
            throw e;
        }
    }
