...
export default function Background() {
    return (
        <div className="absolute inset-0 bg-amber-100 dark:bg-gray-950">
            <svg
                className="absolute inset-0 w-full h-full opacity-[0.20] dark:opacity-[0.07]"
                width="100%"
                height="100%"
            ...
            >
                <pattern id="wavy-pattern" x="0" y="0" width="100" height="20" patternUnits="userSpaceOnUse">
                    <path
                        ...
                        stroke="currentColor"
                        strokeWidth="1"
                        className="text-red-900 dark:text-blue-400"
                    />
                </pattern>
