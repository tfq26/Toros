...
export function SignupForm({
  ...
  return (
    (<form className={cn("flex flex-col gap-6 dark:bg-gray-800 p-10 rounded-lg", className)} {...props}>
      <div className="flex flex-col items-center gap-2 text-center">
        <h1 className="text-2xl font-bold dark:text-gray-100">Sign up for an account</h1>
      ...
      <div className="text-center text-sm">
        Have an account?{" "}
        <a href="/Older Components/Login" className="underline underline-offset-4">
          Login
        </a>
      </div>
    </form>)
