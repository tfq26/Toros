...
const Signup = () => {
    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSignup} className="relative z-10 bg-red-900 p-8 rounded-lg shadow-xl w-full max-w-2xl space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="firstName" value={userData.firstName} onChange={handleChange}
                               className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none" required />
                    </div>
                    <div>
                ...
                <div className="flex items-center space-x-3">
                    <input type="checkbox" name="tosAccepted" checked={userData.tosAccepted} onChange={handleChange}
                           className="w-5 h-5 text-blue-500 focus:ring-blue-400 border-gray-300 rounded" required />
                    <label className="text-gray-100 text-sm">
                        I accept the <a href="/tos" className="text-emerald-500 underline">Terms of Service</a>
                    </label>
                </div>
                ...
                <p className="text-center text-sm text-gray-100 mt-4">
                    ...
                    <button onClick={() => navigate("/auth/login")} className="text-emerald-500 font-semibold underline">
                        Login here
                    </button>
                </p>
            </form>
