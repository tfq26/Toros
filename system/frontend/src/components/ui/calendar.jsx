 ...
 *
 * @param {Object} props - The props for the calendar.
 * @param {number} [props.yearRange=12] - In the year view, the number of years to display at once.
 * @param {boolean} [props.showYearSwitcher=true] - Whether to show the year switcher in the caption.
 */
export function Calendar({
    ...
    const [navView, setNavView] = React.useState("days") // "days" or "years"
...
function Nav({
    ...
    }, [nextMonth, goToMonth, navView, displayYears, onNextClick, setDisplayYears])
            ...
            {Array.from({ length: displayYears.to - displayYears.from + 1 }, (_, i) => {
                ...
                return (
                    <Button
                        ...
                        onClick={() => {
                            setNavView("days")
                            goToMonth(new Date(year, (selected?.getMonth?.() ?? 0)))
                        }}
